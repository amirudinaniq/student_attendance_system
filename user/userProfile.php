...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Profile - Teachers Profile</title>
              ...
              <div class="col-lg-10">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Teachers Profile Update</h3>
                  </div>
                  <div class="card-body">
                    <form method="post" action="userProfile.php" class="mx-auto">
                      <div class="row">
                        <div class="col-auto">
                      ...
                      " type="submit" name="updateProfileBtn" >Save</button>
