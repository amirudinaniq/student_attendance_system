        ...
        <div class="container">
          <div class="row">
            <div class="col col-login mx-auto">
              ...
              <form class="card-opacity" action="adminlogin.php" method="post">
                ...
                <div class="card-body p-6">
                  ...
                  <div class="form-group">
                      <a href="./login.php" class="float-right small">Back to Teachers Login</a>
                  </div>
                  <div class="form-footer">
                    <button type="submit" class="btn btn-primary btn-block" name="loginAdmin_btn">Sign in</button>
                  </div>
                </div>
              </form>
            </div>
