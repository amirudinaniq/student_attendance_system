...
$valueToSearch=$_POST['valueToSearch'];
  $results= mysqli_query($db, "SELECT g.idPelajar, g.nama, g.alamat, namaKelas, g.notelefon, s.Status, s.Tarikh, s.Sebab from kelas k, pelajar g, guru j, kehadiran s where k.idKelas=g.idKelas and k.idKelas=j.idKelas and k.idKelas=s.idKelas and g.idPelajar=s.idPelajar and CONCAT(g.idPelajar, g.nama, g.alamat, namaKelas, s.Status, s.Sebab, s.Tarikh) LIKE '%".$valueToSearch."%' group by Tarikh, idPelajar");
  
}else{
  $results = mysqli_query($db, "SELECT g.idPelajar, g.nama, g.alamat, namaKelas, s.Tarikh, s.Status, s.idKelas, s.Sebab from kelas k, pelajar g, guru j, kehadiran s where k.idKelas=g.idKelas and k.idKelas=j.idKelas and k.idKelas=s.idKelas and g.idPelajar=s.idPelajar group by s.Tarikh, idPelajar"); 
}
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Attendances - Students Attendances</title>
  ...
  <body class="">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    <a href="./attendances.php" class="nav-link active"><i class="fe fe-file-text"></i>Attendances</a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <div class="my-3 my-md-5">
          <div class="container">
            ...
            <div class="col-12">
                <div class="card">
                <form class="card" action="attendances.php" method="post">
                  <div class="card-header">
                    <h3 class="card-title">Students Details</h3>
                  <div class="col-md-10" align="right">
                    <button type="button" id="report_button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#formModal">Class Report</button>
                  </div>
                  </div>
  ...
  <div class="modal-dialog">
    <form method="post" id="report_form" action="attendances.php">
      <div class="modal-content">
          ...
          <div class="container">
            ...
            <select name="idKelas" id="idKelas" class="form-control">
              <option value="">Select Class</option>
                <?php $sql=mysqli_query($db, "SELECT * from kelas");
                foreach ($sql as $class) {
                  echo '<option value="'.$class['idKelas'].'">'.$class['namaKelas'].'</option>';
                }
                ?>
            </select>
          </div>
        ...
        <div class="modal-footer">
          <input type="submit" name="create_report" id="create_reportStudents" class="btn btn-success btn-sm" value="Report" />
