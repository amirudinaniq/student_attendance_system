      ...
      <div class="flex-fill">
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="row">
              <div class="col-12">
                <form class="card" action="form-elementsTeachers.php" method="post">
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          <label class="form-label">Teachers No</label>
                          <input type="text" class="form-control" name="idGuru" placeholder="GG000.." required=""/>
                        </div>
						          <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="notelefon" placeholder="Number Phone.." required=""/>
                        </div>
                      <div class="form-group">
                        <label class="form-label">Address</label>
                        <input type="text" class="form-control" name="alamat" placeholder="Full Address.." required=""/>
                      </div>
                      <div class="form-group">
                ...
                <div class="card-footer text-right">
                  <div class="d-flex">
                    ...
                    <button type="submit" class="btn btn-primary ml-auto" name="teachers_btn">Send data</button>
                  </div>
                </div>
              </div>
              </form>
