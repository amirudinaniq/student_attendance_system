<?php 
  ...
  if (isset($_GET['editStudents'])) {
    $Id  = $_GET['editStudents'];
    $update=true;
    $record = mysqli_query($db, "SELECT * FROM pelajar WHERE idPelajar='$Id'");
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Students - Update Profile</title>
                  ...
                  <div class="card-body">
                    <form method="post" action="updateStudents.php" class="mx-auto">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" name="idPelajar" value="<?php echo $id; ?>" readonly />
                      </div>
                      <div class="form-group">
                      ...
                      " type="submit" name="updateStudentsBtn" >Save</button>
                      <a href="students.php" class="btn btn-primary ml-auto" >Close</a>
                      </div>
                    </form>
                  </div>
                </div>
